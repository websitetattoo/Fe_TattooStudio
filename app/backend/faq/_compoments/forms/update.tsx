...
import { useUpdateFaq } from "@/app/query/faq/useUpdateFaq";
//Types
...
export const UpdateFormFaq: React.FC<UpdateFormProps> = ({ initialData }) => {
  const params = useParams();
  const [open, setOpen] = useState(false);
  const [error, setError] = useState<{ [key: string]: string }>({});
  //Khởi tạo giá trị ban đầu
  const initialPostFormData: TypeFormPostFaq = {
    id: "",
    title: "",
    content: "",
  };
