...
export default function index() {
  ...
  const artPoliciesList = [
    {
      ...
      description: [
        "Florida Kings Tattoo often have a policy of not tattooing anyone under a certain age, typically 18 or 16 with parental consent. This is to comply with legal requirements and ensure responsible decision-making."
      ],
      className: true
    },
    {
      ...
      description: [
        "Florida Kings Tattoo have strict policies to ensure the health and safety of both artists and clients. This include maintaining a clean and sterile environment, following proper sterilization and infection control procedures, using disposable and single-use equipment, and adhering to local health department regulations."
      ],
      className: true
    },
    {
      ...
      description: [
        "Florida Kings tattoo require clients to provide valid identification to prove your age and consent. This is to ensure compliance with legal requirements and protect both the client and the artist."],
      className: true
    },

    {
      ...
      subtitle: "Minimum cost differs per artist. Rates will vary depending on the artist, size, design, and etc. ",
      description: [
        "In the consultation process, you will receive a quote. This is subject to change based on the final design and size chosen.",
  ...
  return (
    <div className="bg-tattoo-color-bg">
      <div className="w-full lg:w-9/12 lg:m-auto py-12">
        ...
        <div className="px-12 md:px-0">
          <div className="pb-16 md:flex md:justify-center md:items-center">
            <div className="md:pb-8 md:w-9/12 text-center text-white text-xl lg:text-2xl lg:w-full">{artPolicyTitle}</div>
          </div>
